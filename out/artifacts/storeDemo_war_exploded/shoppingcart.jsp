...
<%--<c:if test="${empty categories }">
		<jsp:forward page="/MainServlet?op=loading"></jsp:forward>
</c:if>--%>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="${pageContext.request.contextPath }/MainServlet?op=loading" class="selected">主页</a></li>
            </ul>
            <br style="clear: left" />
        ...
        <div id="content" class="float_r">
        	...
        	<form action="">
	        	<table width="680px" cellspacing="0" cellpadding="5">
	                      ...
	                      <c:if test="${!empty user }">
		                      <c:forEach items="${shoppingCar.shoppingItem}" var="item">
									<tr>
			                        	<td><img src="${item.value.product.imgurl }" style="width: 130px;height: 150px" alt="" /></td>
			                        	<td>${item.value.product.pname }</td>
			                            <td align="center"><font style="width: 20px; text-align: right" >${item.value.subcount }</font> </td>
			                            <td align="right">${item.value.product.estoreprice } </td>
			                            <td align="right">${shoppingCar.total } </td>
			                            <td align="center"> 
			                            	<a href="${pageContext.request.contextPath }/CartServlet?op=delItem&uid=${shoppingCar.user.uid}&pid=${item.value.product.pid}">
                    ...
                    <c:if test="${!empty shoppingCar.shoppingItem}"><p><a href="${pageContext.request.contextPath }/placeOrder.jsp">立即购买</a></p></c:if>
