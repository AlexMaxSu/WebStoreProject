					...
					<c:forEach items="${orderitems }" var="orderitem">
						<tr>
							<td height="2" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="checkbox" id="pid" value="${orderitem.itemid }" />
								</div>
							</td>
							...
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/OrderServlet?op=deleteOrderItems&itemid=${orderitem.itemid}">删除</a>
								</div>
							</td>
					</tr>
					</c:forEach>
